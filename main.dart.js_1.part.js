...
Ap:function(d){var x=0,w=P.bj(y.X),v,u,t,s,r
var $async$Ap=P.bk(function(e,f){if(e===1)return P.bg(f,w)
while(true)switch(x){case 0:x=3
return P.aX(G.Cd(C.a.af(d,"http")?d:"https://stevertus.com/"+d,null),$async$Ap)
case 3:u=f
t=u.e
...
return P.bi($async$Ap,w)},
An:function(d){var x=0,w=P.bj(y.z),v,u
var $async$An=P.bk(function(e,f){if(e===1)return P.bg(f,w)
while(true)switch(x){case 0:u=C.n
x=3
return P.aX(G.Ap(d),$async$An)
case 3:v=u.aP(0,f)
x=1
break
case 1:return P.bh(v,w)}})
return P.bi($async$An,w)}},Y,R,K={
II:function(){return C.c4},
PN:function(d,e){return new K.rd(E.K(y.F.a(d),H.l(e),y.Q))},
PO:function(d,e){return new K.re(E.K(y.F.a(d),H.l(e),y.Q))},
PP:function(d,e){y.F.a(d)
H.l(e)
return new K.rf(N.ag(),E.K(d,e,y.Q))},
PQ:function(d,e){return new K.lp(E.K(y.F.a(d),H.l(e),y.Q))},
PR:function(d,e){return new K.rg(E.K(y.F.a(d),H.l(e),y.Q))},
PS:function(d,e){return new K.rh(E.K(y.F.a(d),H.l(e),y.Q))},
PT:function(d,e){y.F.a(d)
H.l(e)
return new K.ri(N.ag(),E.K(d,e,y.Q))},
PU:function(d,e){y.F.a(d)
H.l(e)
return new K.rj(N.ag(),E.K(d,e,y.Q))},
PV:function(){return new K.rk(new G.cQ())},
...
xZ:function xZ(){}},N,E,M,Q,D,O,V,A={
MB:function(d,e,f){var x={}
x.a=null
x.b=!0
x.c=null
return new A.AK(x,d,f,e)},
...
F=c[24]
X.aO.prototype={
C:function(){G.An("tekpack.json").b1(new X.y_(this),y.P).iL(new X.y0())}}
X.k5.prototype={
nI:function(d){var x,w,v,u,t,s=this,r="texture",q="isNotBlue",p=J.a3(d),o=p.i(d,"name")
s.a=H.i(o==null?"":o)
o=p.i(d,"description")
o=o==null?null:J.Hl(o,"\n","<br>")
s.b=o==null?"":o
o=p.i(d,r)
o=H.i(o==null?"":o)
s.d=o
if(C.a.af(o,"/"))s.d="assets/tekpack"+o
s.c=H.bA(p.i(d,q)!=null&&p.i(d,q))
s.suc(H.a([],y.i))
for(o=y.w,x=y.h,w=0;w<=8;++w){v=x.a(J.H8(o.a(p.i(d,"crafting")),new X.xY(w),new X.xZ()))
if(v!=null&&J.Q(v,r)!=null){u=H.i(J.Q(v,r))
if(J.CP(u,"/"))u="assets/tekpack"+u}else u=null
t=s.e;(t&&C.b).m(t,u)}},
suc:function(d){this.e=y.G.a(d)}}
K.ip.prototype={
...
i.ch=new K.P(new D.J(w,K.Ok()),w)
w=i.cx=new V.E(19,i,T.Z(d))
i.cy=new K.P(new D.J(w,K.Ol()),w)
w=i.db=new V.E(20,i,T.Z(d))
i.dx=new K.P(new D.J(w,K.Op()),w)
w=y.L
J.aH(q,"click",i.B(i.grO(),w,w))
J.aH(l,"click",i.B(i.grQ(),w,w))
w=i.d
...
u.f=w}v=t.b
r=u.x
if(r!=v){u.Q.innerHTML=$.c_.c.mV(v)
u.x=v}},
F:function(){this.c.H()}}
K.lp.prototype={
q:function(){var x,w=this,v=document.createElement("div")
...
K.rk.prototype={
q:function(){var x,w,v=this,u=new K.ip(E.av(v,0,3)),t=$.Ey
if(t==null)t=$.Ey=O.ax($.NJ,null)
u.b=t
...
v=0
while(!0){x=H.zD(J.au(s.i(d,u)))
if(typeof x!=="number")return H.y(x)
if(!(v<x))break
C.b.m(t,X.IH(w.a(J.Q(s.i(d,u),v))));++v}}},
$S:4}
X.y0.prototype={
